# -*- coding: utf-8 -*-
"""TA_Orbit_Explain.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1xcDEpHzNKM6MJ83qu1VtdsE46a7C33zj
...
Pada proyek ini, topik yang dibahas ialah mengenai `kesehatan` yang di buat untuk mengklasifikasikan orang yang beresiko terkena penyakit stroke atau tidak. Proyek ini dibuat untuk Tugas Akhir Orbit
...
dataset didownload secara manual oleh peneliti
...
"""<details>
  <summary>Penjelasan : <h4></h4></summary>
